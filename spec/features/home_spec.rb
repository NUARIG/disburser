...
RSpec.feature 'Repositories', type: :feature do
  before(:each) do
    ...
    @repository_moomin = FactoryGirl.create(:repository, name: 'Moomins', public: true, general_content: @repository_moomin_general_content, data_content: @repository_moomin_data_content, specimen_content: @repository_moomin_specimen_content, general_content_published: @repository_moomin_general_content, data_content_published: @repository_moomin_data_content, specimen_content_published: @repository_moomin_specimen_content, data_dictionary: Rack::Test::UploadedFile.new(File.open(File.join(Rails.root, '/spec/fixtures/files/data_dictionary.docx'))),irb_template: Rack::Test::UploadedFile.new(File.open(File.join(Rails.root, '/spec/fixtures/files/irb_template.docx'))), custom_request_form: Rack::Test::UploadedFile.new(File.open(File.join(Rails.root, '/spec/fixtures/files/custom_request_form.docx'))))
